package projectv2.technocoders.com.finalproject.home.leave.leavecharts.half_day;
...
public class HalfDay_details extends AppCompatActivity {

    PieChart pieChart;
    private ArrayList<Individual_leave_charts_model> data;
    Login eidhalfdaycharts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_half_day_details);

        pieChart = (PieChart)findViewById(R.id.halfdaypiechart);
        String eid = eidhalfdaycharts.EIDemployee;
        ...
        call.enqueue(new Callback<List<Individual_leave_charts_model>>() {
            ...
            public void onResponse(Call<List<Individual_leave_charts_model>> call, Response<List<Individual_leave_charts_model>> response) {
                ...
                float leavetaken = Float.parseFloat(data.get(1).getTakencount());
                float leaveleft = Float.parseFloat(data.get(1).getLeftcount());
                Toast.makeText(HalfDay_details.this,"Sending Success",Toast.LENGTH_SHORT).show();
                ...
                PieDataSet dataSet = new PieDataSet(yValues, "Half Days");
                ...
                Toast.makeText(HalfDay_details.this,"Sending Successful",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<List<Individual_leave_charts_model>> call, Throwable t) {
                ...
                Toast.makeText(HalfDay_details.this,"Sending Fail"+t,Toast.LENGTH_LONG).show();
            }
        });
