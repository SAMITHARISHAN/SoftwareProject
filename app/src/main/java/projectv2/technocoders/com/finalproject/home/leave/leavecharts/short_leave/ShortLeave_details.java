package projectv2.technocoders.com.finalproject.home.leave.leavecharts.short_leave;
...
public class ShortLeave_details extends AppCompatActivity {

    PieChart pieChart;
    private ArrayList<Individual_leave_charts_model> data;
    Login eidshortLeavecharts;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_short_leave_details);


        pieChart = (PieChart)findViewById(R.id.shortleavepiechart);
        String eid = eidshortLeavecharts.EIDemployee;
        ...
        call.enqueue(new Callback<List<Individual_leave_charts_model>>() {
            ...
            public void onResponse(Call<List<Individual_leave_charts_model>> call, Response<List<Individual_leave_charts_model>> response) {
                ...
                float leavetaken = Float.parseFloat(data.get(3).getTakencount());
                float leaveleft = Float.parseFloat(data.get(3).getLeftcount());
                Toast.makeText(ShortLeave_details.this,"Sending Success",Toast.LENGTH_SHORT).show();
                ...
                PieDataSet dataSet = new PieDataSet(yValues, "Short Leaves");
                ...
                Toast.makeText(ShortLeave_details.this,"Sending Successful",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<List<Individual_leave_charts_model>> call, Throwable t) {
                ...
                Toast.makeText(ShortLeave_details.this,"Sending Fail"+t,Toast.LENGTH_LONG).show();
            }
        });
