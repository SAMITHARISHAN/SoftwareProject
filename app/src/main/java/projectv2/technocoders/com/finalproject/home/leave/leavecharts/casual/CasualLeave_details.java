package projectv2.technocoders.com.finalproject.home.leave.leavecharts.casual;
...
public class CasualLeave_details extends AppCompatActivity {

    PieChart pieChart;
    private ArrayList<Individual_leave_charts_model> data;
    Login eidcasualLeavecharts;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_casual_leave_details);

        pieChart = (PieChart)findViewById(R.id.casualleavepiechart);
        String eid = eidcasualLeavecharts.EIDemployee;
        ...
        call.enqueue(new Callback<List<Individual_leave_charts_model>>() {
            ...
            public void onResponse(Call<List<Individual_leave_charts_model>> call, Response<List<Individual_leave_charts_model>> response) {
                ...
                float leavetaken = Float.parseFloat(data.get(0).getTakencount());
                float leaveleft = Float.parseFloat(data.get(0).getLeftcount());
                Toast.makeText(CasualLeave_details.this,"Sending Success",Toast.LENGTH_SHORT).show();
               ...
               pieChart.setUsePercentValues(true);
                ...
                PieDataSet dataSet = new PieDataSet(yValues, "Casual Leaves");
                ...
                Toast.makeText(CasualLeave_details.this,"Sending Successful",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<List<Individual_leave_charts_model>> call, Throwable t) {
                ...
                Toast.makeText(CasualLeave_details.this,"Sending Fail"+t,Toast.LENGTH_LONG).show();
            }
        });
